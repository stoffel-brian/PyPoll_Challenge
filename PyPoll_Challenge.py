...
with open(file_to_save, "w") as txt_file:
    ...
    largest_county_summary = (
        ...
        #The below two lines are not required for the module challenge; Possible extra credit???
        #f"Largest Turnout Count: {county_count:,}\n"
    ...
    for candidate_name in candidate_votes:
        ...
        can_votes = candidate_votes.get(candidate_name)
        ...
        if (can_votes > winning_count) and (can_vote_percentage > can_winning_percentage):
            ...
            can_winning_percentage = can_vote_percentage
    ...
    winning_candidate_summary = (
        ...
        f"Winning Percentage: {can_winning_percentage:.1f}%\n"
        f"-------------------------\n")
